...
import type { AggregatorRouterV6, AggregatorRouterV6Interface } from "../AggregatorRouterV6";
...
export class AggregatorRouterV6__factory {
	static readonly abi = _abi;
	static createInterface(): AggregatorRouterV6Interface {
		return new Interface(_abi) as AggregatorRouterV6Interface;
	}
	static connect(address: string, runner?: ContractRunner | null): AggregatorRouterV6 {
		return new Contract(address, _abi, runner) as unknown as AggregatorRouterV6;
	}
}
